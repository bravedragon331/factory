...
var getAll = function(callback) {
  db.query(`
    SELECT  orders.buyername AS buyer,
            ...
            sum(sewdaily.conf) AS conf,
            sum(shipment.size1+shipment.size2+shipment.size3+shipment.size4+shipment.size5+shipment.size6+shipment.size7+shipment.size8+shipment.size9+shipment.size10) AS shipment            
