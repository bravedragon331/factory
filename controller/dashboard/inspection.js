...
exports.index = function(req, res){
  ...
  new Promise((resolve, reject) =>{
    ...
    res.render('dashboard/inspection/inspection', {customers: customers, colors: colors, allcustomers: allcustomers, role: res.role});    
  })
}
...
exports.add_inspection = function(req, res){
...
exports.update_inspection = function(req, res){
...
exports.list_inspection = function(req, res){
  ...
  var p1 = new Promise((resolve, reject) => {
    Inspection.list(req.body, function(err, result){
      if(err){
        inspectionlist = [];
        reject();
      }else{
  ...
  .then(() => {
    ...
    res.json({isSuccess: true, inspection: inspectionlist, cut: cut, order: order, sew: sew});
  })
}
